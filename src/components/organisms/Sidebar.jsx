...
const Sidebar = ({ isCollapsed, setIsCollapsed }) => {
  ...
  const allMenus = [
...

    {
      ...
      division: 'Finance',
      children: [
        { name: 'Aging Hutang', path: '/hutang/aging-hutang', roles: ['S', 'A'], division: 'Finance' },
        { name: 'Invoice Vendor', path: '/hutang/invoice-vendor', roles: ['S', 'A'], division: 'Finance' },
      ],
    },

    {
      ...
      division: 'Finance',
      children: [
        { name: 'Aging Piutang', path: '/piutang/agingpiutang', roles: ['S'] },
        { name: 'Approval Customer', path: '/piutang/approval-customer', roles: ['S'] },
        { name: 'Bukti Tanda Terima (BTT) - Tagih Turun', path: '/piutang/BTTTagihTujuan', roles: ['S'] },
        { name: 'Credit Note', path: '/piutang/credit-note', roles: ['S'] },
        { name: 'Invoice', path: '/piutang/invoice', roles: ['S'] },
        { name: 'Kondisi BTT dan Order Jemput', path: '/piutang/kondisi-btt', roles: ['S'] },
        { name: 'Master Faktur Pajak', path: '/piutang/faktur-pajak', roles: ['S'] },
        { name: 'Mutasi Piutang', path: '/piutang/mutasi-piutang', roles: ['S'] },
        { name: 'Penagihan invoide oleh Kolekter', path: '/piutang/tagih-invoice', roles: ['S'] },
        //{ name: 'Pencairan Giro Mundur Kredit', path: '/piutang/pencairan-giro', roles: ['S'] },
        { name: 'Penerimaan Pembayaran', path: '/piutang/penerimaan-pembayaran', roles: ['S'] },
        { name: 'Penerimaan Penagihan Kolektor', path: '/piutang/penerimaan-penagihan-kolektor', roles: ['S'] },
        { name: 'Penerimaan Setoran Agen', path: '/piutang/penerimaan-setoran-agen', roles: ['S'] },
        { name: 'Proforma Invoice', path: '/piutang/proforma-invoice', roles: ['S'] },
        { name: 'Proses Piutang', path: '/piutang/proses-piutang', roles: ['S'] },
        { name: 'Revisi Btt Apl (Harga)', path: '/piutang/revisi-btt-apl', roles: ['S'] },
        { name: 'Saldo Awal Piutang', path: '/piutang/saldo-awal-piutang', roles: ['S'] },
        { name: 'Tukar Faktur', path: '/piutang/tukar-faktur', roles: ['S'] },
      ]
    },
