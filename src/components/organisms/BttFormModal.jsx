...
const BttFormModal = ({ isOpen, onClose, onSave, isDarkMode }) => {
    ...
    useEffect(() => {
        ...
        // Jika input PELANGGAN dikosongkan / diketik "UMUM", pemicu auto-generate ID jalan
        ...
        // 🎯 LIVE SEARCH KE TABEL mkt_m_customer DENGAN PARAMETER LENGKAP
        if (keywordCustomer && keywordCustomer.length >= 1) {
            ...
            // 💡 Kirim search, agen_id, dan role_akses ke Backend Go!
    ...
    const executeFinalSaveDataToGolang = async (payloadKargo, finalResiID) => {
        ...
        try {
            ...
            // Penanganan agen_id numerik maupun string
    ...
    const RenderDropdownMelayang = () => {
        if (!Array.isArray(geoSuggestions) || geoSuggestions.length === 0) {
            return null;
        }
                    ...
                    <div className="p-8 rounded-3xl border-l-8 border-teal-500 bg-teal-50/20 border-y border-r border-gray-100 space-y-6 relative">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 relative">
                            ...
                            <div className="flex flex-col gap-1 w-full relative">
                                ...
                                <input
                                    type="text"
                                    className="w-full h-14 p-4 border-2 border-teal-300 rounded-xl text-lg focus:border-teal-500 outline-none bg-white font-bold text-teal-900 shadow-sm uppercase"
