// src/constants/menuListDBS.js
export const MENU_LIST_DBS = [
        ...
        subMenus: [
            ...
            { id: 'marketing_closing_harian_agen', name: 'Closing Harian Agen' },
            {
                ...
                subMenus: [
                    ...
                    { id: 'marketing_laporan_btt_kirim_outstanding', name: 'Btt Kirim Outstanding' },
                    { id: 'marketing_laporan_perjalanan_btt', name: 'Perjalanan Btt' },
                    { id: 'marketing_laporan_penjualan_penerimaan', name: 'Penjualan Dan Penerimaan' },
                    { id: 'marketing_laporan_omset_penjualan', name: 'Laporan Omset Penjualan' },
                    { id: 'marketing_laporan_monitoring_btt', name: 'Monitoring Btt' },
                ]
            }
        ]
    },
        ...
        subMenus: [
            ...
            { id: 'master_trayek', name: 'Master Trayek' },
            {
                ...
                subMenus: [
                    ...
                    { id: 'tarif_handling', name: 'Tarif Handling' },
                    { id: 'tarif_paket_customer', name: 'Tarif Paket Customer' },
                    { id: 'tarif_paket_kurir', name: 'Tarif Paket Kurir' },
